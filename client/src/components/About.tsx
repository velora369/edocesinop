          ...
          >
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                A <span className="font-dancing text-xl"><span className="text-[#00A9A5]">É</span><span className="text-[#4B2E1F]">Do</span><span className="text-[#00A9A5]">ce</span></span> nasceu da paixão por transformar ingredientes premium em experiências gastronômicas únicas. Cada doce é preparado artesanalmente, priorizando qualidade e sabor em cada criação.
              </p>
            </div>
